...
public class IsdaCustomFilters {
	...
	public static void main(String[] args) throws Exception {
		...
		driver.findElement(By.xpath(".//*[@id='tbReportName']")).sendKeys("Is12233_Nw1221");
...
//		driver.close();
		...
		driver.findElement(By.xpath(".//*[@id='tbReportName']")).sendKeys("pb+___234");
		driver.findElement(By.xpath(".//*[@id='Submit']")).click();
		Thread.sleep(20000);
